...
<table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		...
		<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
			...
			<td align="center">
			<a href="#" class="pn-opt">查看</a> | <a href="javascript:;" class="pn-opt" onclick="toUpdatePage(${product.id },${page.pageNo },${page.pageSize })">修改</a> | <a href="javascript:;" onclick="if(confirm('您确定删除吗？')) {window.location.href='deleteProduct.do?id=${product.id}&pageNo=${pagination.pageNo }&name=${product.name }&isShow=${product.isShow==null?2:product.isShow }&brandId=${product.brandId==null?0:product.brandId }'}" class="pn-opt">删除</a> | <a href="javascript:;" onclick="window.location.href='skuList.do?productId=${product.id }'" class="pn-opt">库存</a>
			</td> 
		</tr>
		</c:forEach>
	</tbody>
